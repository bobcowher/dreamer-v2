...
def visualize_decoded_image(world_model, memory, num_samples=4, filename="decoder_check.png", gru_hidden_dim=128):
    """
    ...
    for i in range(num_samples):
        ...
        recon_labeled = add_label(recons[i], f"Decoded {i+1}")
